...
if (! nv_function_exists('nv_news_block_top_news')) {
    ...
    function nv_block_config_top_news_blocks($module, $data_block, $lang_block)
    {
        ...
        $html .= '	<td><input type="text" name="config_duration" class="form-control w200" size="5" value="' . $data_block['duration'] . '"/></td>';
        $html .= '</tr>';
		
		$html .= "<tr>";
		$html .= "<td>". $lang_block['direction'] ."</td>";
		$html .= "<td>";
		$sorting_array = array( 'left' => $lang_block['left'], 'right' => $lang_block['right'], 'up' => $lang_block['up'], 'down' => $lang_block['down']);
