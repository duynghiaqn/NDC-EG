...
<div class="container-fluid nvwrap">
	...
	<footer id="footer" class="row">
		<div class="footer-content">
			...
			<div class="imgstat">
				<a title="CMS GOV" href="#" target="_blank"><img alt="CMS GOV" src="{NV_BASE_SITEURL}{NV_ASSETS_DIR}/images/banner_nukeviet_88x15.jpg" width="88" height="15" class="imgstatnkv"/></a>
				<br/>
			</div>
		</div>
	</footer>
