...
<div class="nv-fullbg">
    <form method="post" action="{ACTION_FILE}" onsubmit="return nv_validForm(this);" novalidate>
		...
		<!-- END: cats -->
		<div class="form-group form-group col-sm-12 col-md-24">
			<div class="input-group">
				<span class="input-group-addon">
		...
		<div class="form-group form-group col-sm-12 col-md-24">
            <div>
    			<textarea cols="10" name="fcon" class="form-control required" maxlength="1000" placeholder="{LANG.content}" onkeypress="nv_validErrorHidden(this);" data-mess="{LANG.error_content}"></textarea>
            </div>
		</div>
		<div class="form-group">
            <div class="middle text-center clearfix">
                ...
                <input type="text" placeholder="{LANG.captcha}" maxlength="{NV_GFX_NUM}" value="" name="fcode" class="fcode required form-control display-inline-block" style="width:auto;" data-pattern="/^(.){{NV_GFX_NUM},{NV_GFX_NUM}}$/" onkeypress="nv_validErrorHidden(this);" data-mess="{LANG.error_captcha}"/>
            </div>
		</div>
		<div class="form-group hidden">
		...
		<div class="text-center form-group">
			...
			<input type="submit" value="{LANG.sendcontact} " name="btsend" class="btn btn-primary btn-lg btn-block text-center"/>
		</div>
	</form>
