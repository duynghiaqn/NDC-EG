    ...
    <div class="row">
        <div class="col-sm-12 col-md-24">
            ...
            <div class="panel panel-primary">
                ...
                <h3><i class="fa fa-address-book" aria-hidden="true"></i>&nbsp;{DEP.full_name}</h3>
                </div>
        ...
        <div class="col-sm-24 col-md-24">
            <div class="panel panel-primary">
                <div class="panel-heading"><h3><i class="fa fa-envelope" aria-hidden="true"></i>&nbsp;{GLANG.feedback}</h3></div>
