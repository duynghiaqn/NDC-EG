...
<div class="schedule-list-tool clearfix">
    ...
    <div class="pull-right">
        ...
        <a class="btn btn-info btn-sm hidden" rel="nofollow" title="{LANG.event_print}" href="{LINK_PRINT}"><i class="fa fa-print"></i></a>
        <a class="btn btn-info btn-sm hidden" rel="nofollow" title="{LANG.event_download}" href="{LINK_DOWNLOAD}"><i class="fa fa-download"></i></a>
    </div>
</div>
<!-- BEGIN: empty -->
