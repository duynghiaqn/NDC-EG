...
<script>
        jQuery(document).ready(function ($) {
            ...
            window['banner-rotator-2.source_{bid}']=new $JssorSlider$("banner-rotator-2.source_{bid}", options);
            function ScaleSlider() {
                var parentWidth = window['banner-rotator-2.source_{bid}'].$Elmt.parentNode.clientWidth;
                if (parentWidth)
                    window['banner-rotator-2.source_{bid}'].$ScaleWidth(Math.min(parentWidth,{width}));
                else
    ...
    <div id="banner-rotator-2.source_{bid}" style="display: inline-block;position: relative; top: 0px; left: 0px; width: {width}px; height: {height}px;">
